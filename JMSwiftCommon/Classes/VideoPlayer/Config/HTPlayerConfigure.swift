...
public struct HTPlayerConfigure {
    ...
    public struct HTPlayerImage {
        ...
        public init(back: UIImage? = HTImageHelper.imageWithName("play_back"),
                    more: UIImage? = HTImageHelper.imageWithName("CLMore"),
                    play: UIImage? = HTImageHelper.imageWithName("play_smail"),
                    pause: UIImage? = HTImageHelper.imageWithName("play_pause_smail"),
                    slider: UIImage? = HTImageHelper.imageWithName("CLSlider"),
                    max: UIImage? = HTImageHelper.imageWithName("play_full_screen"),
                    min: UIImage? = HTImageHelper.imageWithName("play_full_screen"))
        {
            self.back = back
            self.more = more
            self.play = play
