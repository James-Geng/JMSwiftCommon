...
class HTPlayerContentView: HTPlayerBaseContentView {
    ...
    private lazy var backButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_backButtonAction), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var moreButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_moreButtonAction), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var CCSubtitleButton: UIButton = {
        ...
        view.addTarget(self, action: #selector(ht_CCSubTitleButtonAction), for: .touchUpInside)
        return view
    }()
    
    private lazy var shareButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_shareButtonAction), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var playCenterButton: UIButton = {
        let view = UIButton()
        view.isHidden = true
        view.addTarget(self, action: #selector(ht_playCenterButtonAction(_:)), for: .touchUpInside)
        return view
    }()

    private lazy var playButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_playButtonAction(_:)), for: .touchUpInside)
        return view
    }()

    private lazy var fullButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_fullButtonAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var sliderView: HTSlider = {
        ...
        view.addTarget(self, action: #selector(ht_progressSliderTouchBegan(_:)), for: .touchDown)
        view.addTarget(self, action: #selector(ht_progressSliderValueChanged(_:)), for: .valueChanged)
        view.addTarget(self, action: #selector(ht_progressSliderTouchEnded(_:)), for: [.touchUpInside, .touchCancel, .touchUpOutside])
        return view
    }()
    ...
    private lazy var playBackUpButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_playBackUpAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var playAdvanceButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_playAdvanceAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var playLockButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_playLockAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var removeADButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_removeADAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var nextEpisodeButton: UIButton = {
        let view = UIButton()
        view.addTarget(self, action: #selector(ht_playNextEpisodeAction(_:)), for: .touchUpInside)
        return view
    }()
    ...
    private lazy var selectEpisodeButton: UIButton = {
        ...
        view.addTarget(self, action: #selector(ht_selectEpisodeAction(_:)), for: .touchUpInside)
    ...
    private lazy var failButton: UIButton = {
        ...
        view.addTarget(self, action: #selector(ht_failButtonAction), for: .touchUpInside)
        return view
    }()
...
//    }()
    ...
    private lazy var tapGesture: UITapGestureRecognizer = {
        let gesture = UITapGestureRecognizer(target: self, action: #selector(ht_tapAction))
        gesture.delegate = self
        return gesture
    }()

    private lazy var panGesture: UIPanGestureRecognizer = {
        let gesture = UIPanGestureRecognizer(target: self, action: #selector(ht_panDirection(_:)))
...
//       }
    ...
    func ht_reloadTopContentViewConstraints() {
   ...
   override func updateConfig() {
       ...
       CCSubtitleButton.setImage(UIImage(named: "icon_subtitle_disable"), for: .disabled)
       CCSubtitleButton.setImage(UIImage(named: "icon_subtitle_normal"), for: .normal)
       CCSubtitleButton.setImage(UIImage(named: "icon_subtitle_selected"), for: .selected)
       ...
       playCenterButton.setImage(UIImage(named: "play_center_play"), for: .normal)
       playCenterButton.setImage(UIImage(named: "play_center_pause"), for: .selected)
       
       playBackUpButton.setImage(UIImage(named: "play_houtui"), for: .normal)
       playAdvanceButton.setImage(UIImage(named: "play_qianjin"), for: .normal)
       playLockButton.setImage(UIImage(named: "play_jiesuo_zhuangtai_jiesuo"), for: .normal)
       removeADButton.setImage(UIImage(named: "play_remove_ad"), for: .normal)
       nextEpisodeButton.setImage(UIImage(named: "play_next_episode"), for: .normal)
...
//        }
    ...
    override func reloadScreenState() {
        ...
        ht_reloadBottomContentViewConstraints()
        ht_reloadTopContentViewConstraints()
    }
...
//            if screenState != .fullScreen {playCenterButton.isHidden = false}
    ...
    override func ht_setHiddenFullScreenRightPanelView() {
...
@objc private extension HTPlayerContentView {
    func ht_tapAction() {
        if isShowMorePanel {
            ...
            isHiddenToolView ? ht_showToolView() : ht_hiddenToolView()
        }
    }

    func ht_panDirection(_ pan: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            case .horizontal:
                ...
                if veloctyPoint.x > 0 {
                    ...
                    self.fastForwardView.ht_setIsFastForward(true)
                    ...
                    self.fastForwardView.ht_setIsFastForward(false)
        ...
        case .ended, .cancelled:
            ...
            if panDirection == .horizontal {
                ...
                if self.panDirectionBegainCurrentDuration != self.currentDuration {
                    ...
                    delegate?.ht_didClickFastForward(self, fastForwardTime: self.panDirectionBegainCurrentDuration)
                }
            }
    ...
    func ht_backButtonAction() {
        delegate?.ht_didClickBackButton(in: self)
    }

    func ht_moreButtonAction() {
        ht_showMorePanel()
    }
    
    func ht_CCSubTitleButtonAction() {
        
        delegate?.ht_didClickSubTitleSettingButton(in: self, fullState: screenState == .fullScreen, button: CCSubtitleButton, index: 1)
    ...
    func ht_shareButtonAction() {
        
        delegate?.ht_didClickShareButton(in: self)
    }

    func ht_playButtonAction(_ button: UIButton) {
        delegate?.contentView(self, didClickPlayButton: button.isSelected)
    }
    
    func ht_playCenterButtonAction(_ button: UIButton) {
        delegate?.contentView(self, didClickPlayButton: button.isSelected)
    }

    func ht_fullButtonAction(_ button: UIButton) {
    ...
    func ht_failButtonAction() {
        delegate?.ht_didClickFailButton(in: self)
    }

    func ht_progressSliderTouchBegan(_ slider: HTSlider) {
        ht_cancelAutoFadeOutTooView()
        delegate?.contentView(self, sliderTouchBegan: slider)
    }

    func ht_progressSliderValueChanged(_ slider: HTSlider) {
        delegate?.contentView(self, sliderValueChanged: slider)
    }

    func ht_progressSliderTouchEnded(_ slider: HTSlider) {
        ht_autoFadeOutTooView()
        delegate?.contentView(self, sliderTouchEnded: slider)
    }
    
    func ht_playBackUpAction(_ button: UIButton) {
        delegate?.ht_didClickPlayBackUpButton(in: self)
    }
    
    func ht_playAdvanceAction(_ button: UIButton) {
        delegate?.ht_didClickPlayAdvanceButton(in: self)
    }
    
    func ht_playLockAction(_ button: UIButton) {
        
        self.lockScreen = !self.lockScreen
        
        if self.lockScreen {
            
            self.playLockButton.setImage(UIImage(named: "play_jiesuo_zhuangtai"), for: .normal)
        }
        else {
            self.playLockButton.setImage(UIImage(named: "play_jiesuo_zhuangtai_jiesuo"), for: .normal)
        }
        
        self.ht_showToolView()
        
        delegate?.ht_didClickPlayLockButton(in: self, lock: self.lockScreen)
    }
    
    func ht_removeADAction(_ button: UIButton) {
        delegate?.ht_didClickPlayRemoveADButton(in: self)
    }
    
    func ht_playNextEpisodeAction(_ button: UIButton) {
        delegate?.ht_didClickPlayNextEpisodeButton(in: self)
    }
    
    func ht_selectEpisodeAction(_ button: UIButton) {
        
        delegate?.ht_didClickPlaySelectEpisodeButton(in: self, button: button, index: 0)
...
private extension HTPlayerContentView {
    ...
    func ht_showMorePanel() {
        isShowMorePanel = true
    }

    func ht_hiddenMorePanel() {
        isShowMorePanel = false
    }

    func ht_showToolView() {
        ...
        if self.lockScreen {
            ...
            self.electricView.ht_cancelElectricTimer()
        }
        else {
            topToolView.snp.updateConstraints { make in
            ...
            UIView.animate(withDuration: 0.25, delay: 0) {
                ...
                self.ht_autoFadeOutTooView()
                self.electricView.ht_autoElectricTimer()
            }
        }
...
extension HTPlayerContentView {
    ...
    func ht_loadSTRFile(fileFromRemote filePath: URL, encoding: String.Encoding = .utf8) {
        ...
        let dataTask = URLSession.shared.dataTask(with: filePath) { data, response, error in
            ...
            DispatchQueue.main.async {
                ...
                if let checkData = data as Data?, let contents = String(data: checkData, encoding: encoding) {
                    self.ht_show(subtitles: contents)
                }
            }
        }
        dataTask.resume()
    ...
    func ht_loadSTRData(fileData data: Data?) {
    ...
    func ht_show(subtitles string: String) {
        // Parse
